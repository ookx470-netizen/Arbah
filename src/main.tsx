...
import './index.css';
import { startAutoUpdate } from './utils/appVersion';
...
// ============================================================
// التحديث التلقائي الصامت: يفحص وجود نسخة أحدث عند كل تشغيل
// وعند عودة المستخدم للتطبيق، ويطبّقها دون أي تدخل منه —
// فلا يحتاج أحد لمسح بيانات المتصفح يدويًا بعد الآن.
// ============================================================
startAutoUpdate();
